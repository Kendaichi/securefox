  ...
  return (
    <>
        ...
        <div className="max-w-[900px] mx-auto px-6 md:px-10 text-center">
          <FadeIn>
            ...
            <div className="max-w-[640px] mx-auto space-y-4 mb-12">
              <p className="font-barlow font-300 text-sf-text/70 leading-relaxed">
            ...
            <div className="grid grid-cols-3 gap-4">
              {introStats.map((s, i) => (
                <div key={i} className="border border-sf-green/15 py-6 px-4">
                  ...
                  <div className="font-barlow font-300 text-xs text-sf-text/70 uppercase tracking-wider">{s.label}</div>
                </div>
              ))}
            </div>
          </FadeIn>
      ...
      <section className="bg-sf-dark py-24 relative overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-10 lg:px-20 grid md:grid-cols-2 gap-16 items-start relative z-10">
          {/* Left */}
          <FadeIn>
            ...
            <p className="text-sf-text/70 font-barlow font-300 leading-relaxed mb-10">
            ...
            <div className="space-y-5">
              {contactInfo.map((c, i) => (
                <div key={i} className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="font-rajdhani font-600 text-xs uppercase tracking-wider text-sf-text/55 mb-0.5">
                      {c.label}
                    </div>
            ...
            <div className="bg-sf-card border border-sf-green/10 p-8 md:p-12">
              {submitted ? (
                <div className="text-center py-16">
                  ...
                  <p className="font-barlow font-300 text-sf-text/70">
